...
export class StudentsListComponent implements AfterViewInit {
    ...
    rowColors = Array(this.students.length).fill('');
    buttonColors = Array(this.students.length).fill('green');
    buttonLabels = Array(this.students.length).fill('Drain');
    btnText = 'Drain';
    ...
    changeRowColor(index: number) {
        this.rowColors[index] = "green";
        this.buttonColors[index] = "orange";
        this.buttonLabels[index] = 'Drained';
        this.btnText = 'Drained';
      }
    /**
